...
exports.countUsers = exports.getUser = void 0;
...
exports.countUsers = (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const count = yield userModel_1.default.countDocuments();
    if (count === 0) {
        return next(new err_1.default('No users found', 404));
    }
    res.status(200).json({
        status: 'success',
        results: count,
